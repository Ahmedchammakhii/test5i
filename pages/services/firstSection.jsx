...
export const FirstSection = () => {
  ...
  useEffect(()=>{
    ...
    timeline.from("."+style.firstleft+' h1', {
     ...
     ease:"Elastic.easeOut"
    },"-=.8").from("."+style.parag,{x:-1000},"-=1").from("."+style.blurparent,{scale:0})
...
<div className={style.parag} >
  <Image className={style.oorssa} style={{width:"15%",height:"80%",objectFit:"contain",minHeight:"150px"}} src={sec}></Image>
