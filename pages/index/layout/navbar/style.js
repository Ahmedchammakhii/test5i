const styles = {
    ...
    lines_btn: { width: "50px", height: "100%", flexDirection: "column", display: "flex", justifyContent: "center", cursor: "pointer" },
    ...
    quote_container: { display: "flex", alignItems: "center", height: "100%", width: "170px", justifyContent: "center", marginRight: "-10px" },
    links_container: { display: "flex", alignItems: "center", transition: "0.5s" },
    G_father_container: { height: "100vh", width: "100%", marginTop: "-80px", overflow: "hidden" },
    father_container: { transition: "0.6s", float: "right", borderBottomLeftRadius: "100%" },
