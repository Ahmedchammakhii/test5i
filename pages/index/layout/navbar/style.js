const styles = {
    ...
    lines_btn: { width: "50px", height: "100%", flexDirection: "column", display: "flex", justifyContent: "center", cursor: "pointer", zIndex: 2 },
    ...
    quote_container: { display: "flex", alignItems: "center", height: "100%", width: "170px", justifyContent: "center", marginRight: "-10px", zIndex: 2 },
    links_container: { display: "flex", alignItems: "center", transition: "0.5s", zIndex: 2 },
    G_father_container: { background: "yellow", height: "100vh", width: "100%", marginTop: "-80px", overflow: "hidden", position: "absolute", background: "transparent" },
