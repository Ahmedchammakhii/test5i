    ...
    return (
        <div style={{ paddingBottom: "0%", height: 'calc((100vw / 2) * 1.48)', paddingTop: "14%", overflow: "hidden", width: "100vw" }}>
            ...
            <div ref={container} style={{ width: "100vw", transform: "rotate(345deg)", width: "100%", height: "calc(100vw / 2.9)", gap: "80px", display: "flex", whiteSpace: "nowrap" }}>
                <img alt="#" style={{ transition: "0.1s", objectFit: "cover", width: "450px", height: "100%", borderRadius: "75px" }} src={"https://uploads-ssl.webflow.com/63ffb1d8365f630bd05a80b9/640b201b4481e4c4ebf2e944_slide1-p-800.jpg"} />
                <img alt="#" style={{ transition: "0.1s", objectFit: "cover", width: "450px", height: "100%", borderRadius: "75px" }} src={"https://uploads-ssl.webflow.com/63ffb1d8365f630bd05a80b9/640b1d2e6bc211d52461d466_sc4.jpg"} />
                <img alt="#" style={{ transition: "0.1s", objectFit: "cover", width: "450px", height: "100%", borderRadius: "75px" }} src={"https://uploads-ssl.webflow.com/63ffb1d8365f630bd05a80b9/640b1db490971b1346e686fc_sc8-p-800.jpg"} />
                <img alt="#" style={{ transition: "0.1s", objectFit: "cover", width: "450px", height: "100%", borderRadius: "75px" }} src={"https://uploads-ssl.webflow.com/63ffb1d8365f630bd05a80b9/640b1d7eec022d7db635105c_sc7-p-800.jpg"} />
                <img alt="#" style={{ transition: "0.1s", objectFit: "cover", width: "450px", height: "100%", borderRadius: "75px" }} src={"https://uploads-ssl.webflow.com/63ffb1d8365f630bd05a80b9/640b1ea717d12b6f4c6bc028_card3-p-800.jpg"} />
            </div>
