...
export default function MediaBand({ scroll, screen }) {
    ...
    return (
        <div style={{ paddingBottom: "0%", paddingTop: "14%", overflow: "hidden", width: "100vw" }}>
            <div style={{
                color: "white", top: "0", width: "50%", flexDirection: "column", paddingBottom: screen.mobile ? "0" : "100px",
            ...
            <div ref={container} style={{ transform: "rotate(345deg)", width: "100%", height: screen.mobile ? "30vh" : "55vh", gap: "80px", display: "flex", whiteSpace: "nowrap" }}>
            ...
            <div style={{ color: "white", top: "0", paddingTop: screen.mobile ? "0" : "100px", position: "relative" }}>
