...
export default function Catalogue({ scroll }) {
    ...
    return (
        <>
            <div ref={container} style={{ width: "100%", height: "100vh", display: "flex", justifyContent: "center", overflow: "hidden" }}>
                <div style={{ display: "flex", width: "80%", height: "100%", }}>
                    <div style={{
                        ...
                        <div ref={txt}>
                            <h1 style={{ fontSize: "90px", color: "white", fontWeight: "500", position: "relative" }}>
                                Explore our
                                <div style={{
                                    height: "5vw",
                                    width: "5vw",
                    ...
                    <div style={{
                        ...
                        <img alt='#' ref={img} style={{
                            width: "25vw", height: "40vw", float: "right",
            ...
            {/* <div style={{ width: "100vw", height: "100vh", background: "red", position: "fixed", top: 0, zIndex: 15 }}>
