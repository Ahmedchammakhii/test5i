...
export default function Cards({ screen, scroll, containerRef }) {
    ...
    return (
        <div ref={container} style={{ width: "100vw", height: screen === "mobile" ? '100vh' : '200vh', display: "flex", justifyContent: "center", position: "relative", overflow: "hidden", marginTop: screen === "mobile" ? "-20vh" : 0 }}>
