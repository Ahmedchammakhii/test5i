...
export default function Sections({ screen, scroll, color, setBackground }) {
    ...
    const styles = {
        ...
        btn_container: { width: "250px", marginLeft: "-25px", display: "flex", justifyContent: "center", alignItems: "center", height: "150px", position: "relative", left: screen === "mobile" ? "50%" : 0, transform: screen === "mobile" ? "translateX(-50%)" : "none" },
