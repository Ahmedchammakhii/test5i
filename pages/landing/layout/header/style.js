const styles = {
    ...
    main_container: { height: "80px", marginLeft: "3.6%", marginRight: "3.6%", display: "flex", justifyContent: "space-between", position: "fixed", top: "0", width: "calc(100% - (3.6% * 2))", overflow: "hidden" },
    nav_sides: { display: "flex" },
    links: { fontSize: "15px", fontWeight: "600", color: "#6e6e73", marginLeft: "50px" },

    quote: { transition: "0.6s", width: "100px", height: "40px", background: "#3398ff", borderRadius: "50px", color: "white", fontSize: "13px", display: "flex", justifyContent: "center", alignItems: "center", fontWeight: "600" },
