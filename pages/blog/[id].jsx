          ...
          <div className={`${style.blogs} ${style.aaa}`} ref={ref}>
            ...
            >
              <p style={{ width: "75%" }}>
                ...
                Natus soluta asperiores eveniet iusto deserunt. Voluptate non
                sint officiis officia quam necessitatibus culpa veritatis veniam
                ex natus est, facilis eveniet dolorum. Lorem ipsum dolor, sit
                amet consectetur adipisicing elit. Vel ad sequi culpa ex
                reiciendis expedita consequatur sint ipsam quaerat saepe quidem
                adipisci eaque at, ab delectus labore. Officiis, eveniet
                temporibus? Lorem Lorem ipsum dolor sit amet consectetur
                adipisicing elit. Assumenda veritatis, sint, minima iure quasi
                commodi id molestiae beatae voluptatem dignissimos unde,
                consequatur maxime itaque veniam vero voluptatibus temporibus
                ipsum voluptas! Lorem ipsum dolor sit amet consectetur
                adipisicing elit. Quidem neque eaque sint aliquam, ullam,
                quaerat unde, architecto perspiciatis corporis odit voluptas
                mollitia. Cupiditate necessitatibus officia veniam in a
                doloremque minima? Lorem ipsum dolor sit, amet consectetur
                adipisicing elit. Sed expedita, aliq uam blanditiis vitae est
                odio recusandae corrupti distinctio dolores placeat sapiente,
                velit, dolor consequuntur maxime similique quisquam. Asperiores,
                aut obcaecati.
              </p>
            </div>
          </div>
