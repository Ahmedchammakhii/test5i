...
import axios from 'axios';
 const Contact = () => {
    ...
    const handleContact=async ()=>{
      let user = {fin:firstName,ln:lastName,email:email}
      console.log(user)
 try{
    ...
    <div className={styles.page}>
       ...
       <div > <h3>I need</h3> </div>
        ...
        <div className={styles.contactForm}>
           <div> <input id="first" type="text" placeholder="Your name"  onChange={handleInputChange}></input> <div className={styles.line}></div></div>          
            <div><input id="last" type="text" placeholder='Your email' onChange={handleInputChange}></input><div className={styles.line}></div></div>
            <div><input id="email" type="text" placeholder='your number' onChange={handleInputChange}></input><div className={styles.line}  id="li"></div></div>
        </div>
